...
// Global Variables 
const float DRAND_MAX = RAND_MAX;
float *A, *B, *C;
float *C_p;
int n, b;
int n_bar, b_sqr;
...
void Get_matrices(float A[], float B[], int n, int argc);
void Mat_mult(void);
...
void To_blocked(float A[], int n, int b);
void From_blocked(float C[], int n, int b);

/*-------------------------------------------------------------------*/
int main(int argc, char* argv[]) {
   float start1, finish1, start2, finish2;
